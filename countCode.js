...
function countCode(a){
    ...
    // считает количество слов с первой буквой как в аргументе функции и количество слов которые были проверены
    ...
    // возвращает количество слов с первой буквой как в аргументе
